---
title: "Quick Start"
keywords: ["Quick Start | Stophy"]
mode: "wide"
description: "Stophy is an API service that extracts YouTube data and converts it into clean, structured output ready for marketing research and AI automation."
---

## Welcome to Stophy

**Stophy** takes a YouTube input (video, channel, playlist, or search query), collects relevant data such as transcripts, metadata, and comments, and returns it in a normalized, machine-readable format. No manual parsing required.
